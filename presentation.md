...
To remedy this we can install a command line JSON parser/filter called [jq](https://jqlang.org) that will allow us to better parse the JSON response, you can see that in our [second example](./examples/bash-get-status-jq).
